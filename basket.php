    ...
    <div id="container">
        ...
        <div id="basketDiv">
            ...
            <table id="basketTable">
                ...
                if (isset($_REQUEST['btn-update']))  // IF UPDATE CLICKED THEN GET UPDATE ID, QUANTITY VALUE
                {
                ...
                if (isset($_REQUEST["btn-remove"]))  // IF UPDATE CLICKED THEN GET UPDATE ID, QUANTITY VALUE
                {
                    $idToUpdate = $_REQUEST["hidIdUpdate"];
                    $qtyToUpdate = $_REQUEST["qtyUpdate"];
                    $removeflag = true;
                ...
                foreach ($basket as $key => $item)      // DISPLAY EVERYTHING IN BASKET
                {
                    ...
                    echo "<tr id='tr$id'>
                            ...
                            <td class='tdQty'>   <form>  <input type='hidden' name='hidIdUpdate' value='$id'/> <input type='text' name='qtyUpdate' value='$qty'/> <input type='submit' name='btn-update' value='update'/> <input type='submit' name ='btn-remove' value='remove'/> </form> </td>
