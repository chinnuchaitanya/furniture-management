    ...
    <div id="container">
        ...
        <div id="prodInfoBoxDiv">
            ...
            if ($fetchedRow == null) {
                ...
                echo "<form id='frmAddToBasket' method='post' style='width:400px'> 
                              <p>
                                  Price : &#x20B9; $price
                                  <input type='text' name='txtQty' value='1'/> 
                                  <input type='submit' name='btnAddToBasket' value='Add to Basket' onclick='return checkQty();'/> 
                                  <input type='submit' name='btnbuynow' value='Buy Now'  onclick='return checkQty();'/> 
                              </p>
                          </form>";
                echo "$descArray[1]";
                ...
                if (isset($_POST["btnbuynow"])) // IF ADD TO BASKET BUTTON CLICKED
                {
                    $basket = $_SESSION["basket"];
                    $qty = $_POST["txtQty"];
                    $item = array("id" => $id, "name" => $name, "price" => $price, "qty" => $qty, "imageName" => $imgName, "type" => $type);
