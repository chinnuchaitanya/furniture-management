...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkout() {
            ...
            if (document.getElementById('fistname').value == '' || document.getElementById('expiry').value == '' || document.getElementById('cidcvv').value == '' ||  document.getElementById('lastname').value == '' || document.getElementById('cardnumber').value == '') {
                alert("Please Complete the Payment Information.");
                return false;
            }
            else
            {
                if(!/^\d*$/.test(document.getElementById('cidcvv').value))
                {
                ...
                if(!/^\d*$/.test(document.getElementById('expiry').value))
                {
                  alert('Expiry must be Numeric')
                  return false;
                }
                if(document.getElementById('expiry').value.length!=  4)
                {
                  alert('Expiry must be of 4 digit numeric')
                  return false;
                }
    ...
    <div id="container">
        ...
        <div id="basketDiv">
            ...
            <?php
                    ...
                    echo "<h6>Payment Information:</strong></h6>
                          <p><strong>Firt Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input id='fistname' type='text' name='first-name' placeholder='First Name'/></p>
                          <p><strong>Last Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input id='lastname' type='text' name='last-name' placeholder='Surname'/></p>
                          <p><strong>Card Number: &nbsp;</strong><input id='cardnumber' type='text' name='number' placeholder='Card Number'/></p>
                          <p><strong>Expiry: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</strong><input id='expiry' type='text' name='expiry' placeholder='MMYY'/></p>
                          <p><strong>CVV: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input id='cidcvv' type='text' name='cvc' placeholder='CCV'/></p>
            ...
            <div id="checkOutDiv">
                ...
                <?php
                    ...
                    echo "<a onclick='return checkout();' id='aCheckout' href='thankyou.php'>Confirm Order</a>";
