...
<head>
    ...
    else if ($prodType == "table") {
        $title = "Chests";
        $image1 = "<a href='prodInfo.php?prodId=42&amp;type=table'><img src='css/images/table/Bigtable1.jpg' width='300' height='439' alt='Chest images'/>";
        $image2 = "<a href='prodInfo.php?prodId=43&amp;type=table'><img src='css/images/table/Bigtable2.jpg' width='300' height='439' alt='Chest images'/>";
    }
    ...
    <div id="container">
        ...
        <div id="prodListDiv">
            <div id="greyBG">
                ...
                if($prodType == 'bed')
                {
                    echo '<h6> Luxury Beds </h6>';
                }
                else if($prodType == 'table')
                {
                    echo '<h6> Luxury Tables </h6>';
                }
                else if($prodType == 'chair')
                {
                    echo '<h6> Luxury Chairs </h6>';
                }
                else 
                {
                    echo '<h6> Luxury Chests </h6>';
                }
                ?>
            </div>
